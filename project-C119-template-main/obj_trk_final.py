...
def drawBox(img,bbox):
    #write code for this function here
     x,y,w,h = int(bbox[0]), int(bbox[1]), int(bbox[2]), int(bbox[3]), int(bbox[4])
     cv2.reactangle(image,(x,y),((x+w),(y+h)),(255,0,255),3,1)
     pass
...
while True:
    ...
    if success:
        ...
        cv2.putText(image,"lost",(75,90),cv2.FONT_HERSLEY_SIMPLEX,0.7,(0,0,255),2)
